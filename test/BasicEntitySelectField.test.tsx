...
describe('resolveValue', () => {
  ...
  it('returns object of matched values when multiple is 1', () => {
    cat.multiple = 1
    expect(resolveValue(value, cat)).toEqual('code')
  })
  ...
  it('returns array of matched values when multiple is 2', () => {
    cat.multiple = 2
    expect(resolveValue(value, cat)).toEqual(['code', 'tech'])
  })
...
describe('resolveDefault', () => {
  ...
  it('returns array of matched values when multiple is 2', () => {
    cat.default = 'code,tech,devr'
    cat.multiple = 2
    expect(resolveDefault(cat)).toEqual(['code', 'tech'])
  })
  ...
  it('returns empty array when item is empty and multiple is -1', () => {
    cat.multiple = -1
    cat.default = 'code,tech,devr'
    expect(resolveDefault(cat)).toEqual(['code', 'tech', 'devr'])
  })
